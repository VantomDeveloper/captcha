...
[![Latest Stable Version](https://poser.pugx.org/vtmdev/captcha/v/stable.svg)](https://packagist.org/packages/vtmdev/captcha)
[![Latest Unstable Version](https://poser.pugx.org/vtmdev/captcha/v/unstable.svg)](https://packagist.org/packages/vtmdev/captcha)
[![License](https://poser.pugx.org/vtmdev/captcha/license.svg)](https://packagist.org/packages/vtmdev/captcha)
[![Total Downloads](https://poser.pugx.org/vtmdev/captcha/downloads.svg)](https://packagist.org/packages/vtmdev/captcha)
...
- [Captcha for Laravel 5/6/7/8/9/10](#captcha-for-laravel-5-6-7)
  * [Preview](#preview)
...
`vtmdev/captcha` package and setting the `minimum-stability` to `dev` (required for Laravel 5) in your
...
In Windows, you'll need to include the GD2 DLL `php_gd2.dll` in php.ini. And you also need include `php_fileinfo.dll` and `php_mbstring.dll` to fit the requirements of `vtmdev/captcha`'s dependencies.
...
* [L5 Captcha on Packagist](https://packagist.org/packages/vtmdev/captcha)
